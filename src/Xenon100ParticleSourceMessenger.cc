...
Xenon100ParticleSourceMessenger::Xenon100ParticleSourceMessenger(Xenon100ParticleSource *pParticleSource):
...
Xenon100ParticleSourceMessenger::~Xenon100ParticleSourceMessenger()
{
	delete m_pTypeCmd;
	delete m_pShapeCmd;
	delete m_pCenterCmd;
...
void
Xenon100ParticleSourceMessenger::SetNewValue(G4UIcommand * command, G4String newValues)
{
