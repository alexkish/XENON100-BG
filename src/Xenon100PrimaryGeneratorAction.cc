...
Xenon100PrimaryGeneratorAction::Xenon100PrimaryGeneratorAction()
{
	m_pParticleSource = new Xenon100ParticleSource();
...
void
Xenon100PrimaryGeneratorAction::GeneratePrimaries(G4Event *pEvent)
{
