...
Xenon100ParticleSource::Xenon100ParticleSource()
{
	...
	m_pMessenger = new Xenon100ParticleSourceMessenger(this);
...
void
Xenon100ParticleSource::SetParticleDefinition(G4ParticleDefinition * aParticleDefinition)
{
...
void
Xenon100ParticleSource::SetEnergyFile(G4String hEnergyFile)
{
...
G4bool
Xenon100ParticleSource::ReadEnergySpectrum()
{
...
void
Xenon100ParticleSource::ConfineSourceToVolume(G4String hVolumeList)
{
...
void
Xenon100ParticleSource::GeneratePointSource()
{
...
void
Xenon100ParticleSource::GeneratePointsInVolume()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
Xenon100ParticleSource::SetRandomSpherePos()
{
...
G4bool
Xenon100ParticleSource::IsSourceConfined()
{
...
void
Xenon100ParticleSource::GenerateIsotropicFlux()
{
	G4double rndm, rndm2;
	G4double px, py, pz;
...
void
Xenon100ParticleSource::GenerateMonoEnergetic()
{
	m_dParticleEnergy = m_dMonoEnergy;
}

void
Xenon100ParticleSource::GenerateEnergyFromSpectrum()
{
	m_dParticleEnergy = m_hEnergySpectrum.GetRandom()*MeV;
}

void
Xenon100ParticleSource::GeneratePrimaryVertex(G4Event * evt)
{
...
void
Xenon100ParticleSource::GeneratePrimaryVertexFromTrack(G4Track *pTrack, G4Event *pEvent)
{
